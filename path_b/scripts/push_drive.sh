...
#
# Runs automatically from .git/hooks/post-commit, or manually:  bash path_b/scripts/push_drive.sh
set -euo pipefail
...
cd "$(git rev-parse --show-toplevel)"               # works no matter where the script lives
