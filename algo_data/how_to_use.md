...
Create `MyDrive/algo_data/` and put two files in it:
...
2. If your folder is not `MyDrive/algo_data/`, change `CONFIG_PATH` in **cell 0**.
...
...
16:45:10 INFO done: 30 processed files under /content/drive/MyDrive/algo_data/data/processed
```
...
```python
import pandas as pd
root = "/content/drive/MyDrive/algo_data/data/processed"
